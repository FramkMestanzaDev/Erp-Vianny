...
Public Class nsa_produccion
    ...
    Sub abrir()
        ...
        End Try
    End Sub
    Dim Rsr2, Rsr20, Rsr21, Rsr22, Rsr23, Rsr2333, Rsr233 As SqlDataReader
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        MsgBox("SE ANULO EN COMPROBANTE CORRECTAMENTE")
        Dim hj2 As New flog
        Dim hj1 As New vlog
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        abrir()
        Dim va As String
        Dim sql102 As String = "SELECT revisado_3 FROM custom_vianny.dbo.Qag3000 WHERE ncom_3 ='" + Trim(TextBox4.Text) & Trim(TextBox5.Text) + "' and Ano_3 ='" + Label11.Text + "' and talm_3 ='" + TextBox1.Text + "' and Empr_3 ='" + Label4.Text + "' and ccom_3 ='2'"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            For i = 0 To o - 1
				...
				Values (@Empr_3a,@ano_3a,@talm_3a,@ccom_3a,@ncom_3a,@item_3a,@linea_3a, 'PT0101',@cantk_3a,@unidk_3a, '', '', '',@cantk_3a,@pedido_3a, 1, '',@unidk_3a,@ocorte_3a,@ordens_3a,'', '')", conx)
                ...
                cmd15.Parameters.AddWithValue("@cantk_3a", Trim(DataGridView1.Rows(i).Cells(4).Value))
                cmd15.Parameters.AddWithValue("@unidk_3a", Trim(DataGridView1.Rows(i).Cells(5).Value))
                cmd15.Parameters.AddWithValue("@pedido_3a", Trim(DataGridView1.Rows(i).Cells(1).Value))
                cmd15.Parameters.AddWithValue("@ocorte_3a", Trim(DataGridView1.Rows(i).Cells(6).Value))
                cmd15.Parameters.AddWithValue("@ordens_3a", Trim(DataGridView1.Rows(i).Cells(7).Value))
            ...
            If Label14.Text = 2 Then
                ...
                If (respuesta = Windows.Forms.DialogResult.Yes) Then
                    ...
                    Rpt_nia_nsa_prod.TextBox2.Text = 2
            ...
            Else
				...
				Values (@Empr_3a,@ano_3a,@talm_3a,@ccom_3a, @ncom_3a, @fecha, '', '',@ruc, @origen, '', 0, 0, @doc, '',@area, 1, @subfase, 'EXT', 2, '   ', '  ', 0)", conx)
                cmd17.Parameters.AddWithValue("@Empr_3a", Trim(Label4.Text))
                cmd17.Parameters.AddWithValue("@ano_3a", Trim(Label11.Text))
                cmd17.Parameters.AddWithValue("@talm_3a", Trim(TextBox1.Text))
                cmd17.Parameters.AddWithValue("@ccom_3a", ccom)
...
"</head>" &
"<body>
     <FONT COLOR='green'>INFORMACION DE LA NSA DE PRODUCCION</FONT><br/><br/>

<FONT COLOR='blue'>* ESTADO : </FONT> ANULADO <br/>
<FONT COLOR='blue'>* AREA : </FONT>" + Trim(TextBox1.Text) & "-" & Trim(TextBox2.Text) + " <br/>
<FONT COLOR='blue'>* NSA PRODUCCION : </FONT>" + Trim(TextBox4.Text) & "-" & Trim(TextBox5.Text) + " <br/>
...
<FONT COLOR='blue'>* TALLER : </FONT>" + Trim(TextBox10.Text) + "<br/>
        ...
        With message
            ...
            .IsBodyHtml = True
            .Body = Mailz
            .Subject = "NSA PRODUCCION N°" & Trim(TextBox1.Text) & "-" & Trim(TextBox4.Text) & Trim(TextBox5.Text)
    ...
    Sub llenar_combo_box3()
        Try
            ...
            Partida.DataSource = loDataTable

            Partida.DisplayMember = "ocorte_3cg"
            Partida.ValueMember = "ocorte_3cg"
            Partida.DropDownWidth = 90
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Function ELIMINAR(ByVal sql)
        ...
        End If
    End Function
    Private Sub nsa_produccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox4_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox4.KeyDown
        ...
        Else
            If e.KeyCode = Keys.F1 Then
                Ingresos_Salidas_almacen.Label3.Text = Label4.Text
                Ingresos_Salidas_almacen.Label4.Text = Label11.Text
                Ingresos_Salidas_almacen.Label5.Text = TextBox1.Text.ToString().Trim()
                Ingresos_Salidas_almacen.Label6.Text = Trim(TextBox4.Text)
                Ingresos_Salidas_almacen.Label7.Text = "5"
    ...
    Private Sub TextBox5_KeyDown(sender As Object, e As KeyEventArgs) Handles TextBox5.KeyDown
        If e.KeyCode = Keys.Enter Then
            ...
            Dim sql1021 As String = "SELECT A.TAlm_3, 
		       		  ...
		       		  ISNULL(D.nomb_21s,'') AS Nomb_21e,
		       		  E.nomd_3i , b.item_3a, c1.nomb_17, b.ocorte_3a
				      FROM custom_vianny.dbo.Qag3000 A LEFT JOIN custom_vianny.dbo.QAP3000  B 
				      				 ON A.empr_3 = B.empr_3a AND A.ano_3 = B.ano_3a AND A.talm_3 = B.talm_3a AND A.ccom_3 = B.ccom_3a AND A.Ncom_3 = B.NCOM_3a 
				       				 ...
				       				 LEFT JOIN custom_vianny.dbo.QAG210s D 
				       				 ON '01' = D.empr_21S AND a.talm_3 = d.almac_21s AND A.orig_3 = D.dest_21s 
            ...
            If Rsr22.Read() = True Then
                TextBox7.Text = Rsr22(10)
                TextBox6.Text = Rsr22(30)
                TextBox8.Text = Rsr22(4)
                TextBox10.Text = Rsr22(29)
                TextBox12.Text = Rsr22(6)
                TextBox9.Text = Rsr22(11)
                DateTimePicker1.Value = Rsr22(3)
                ...
                While Rsr23.Read()
                    DataGridView1.Rows.Add()
                    DataGridView1.Rows(i51).Cells(0).Value = Rsr23(32)
                    DataGridView1.Rows(i51).Cells(1).Value = Rsr23(25)
                    DataGridView1.Rows(i51).Cells(2).Value = Rsr23(19)
                    DataGridView1.Rows(i51).Cells(4).Value = Rsr23(23)
                    'DataGridView1.Rows(i51).Cells(6).Value = Rsr23(27)
                    DataGridView1.Rows(i51).Cells(7).Value = Rsr23(26)
                    DataGridView1.Rows(i51).Cells(5).Value = Rsr23(24)
                    DataGridView1.Rows(i51).Cells(3).Value = Rsr23(33)
    ...
    Private Sub nsa_produccion_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Me.Activate()
        Me.Focus()
    End Sub
    ...
    Private Sub DataGridView1_CellEndEdit(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellEndEdit
        If DataGridView1.Columns(e.ColumnIndex).HeaderText = "Cantidad" Then
            Dim va, vatot, ve As Integer
            Dim alm As String = ""
            Select Case TextBox1.Text.ToString().Trim()
                Case "0300" : alm = "0300"
                Case "0700" : alm = "0300"
                Case "0400" : alm = "0700"
                Case "0600" : alm = "0400"
            ...
            End Select
            va = 0
            Dim sql1023 As String = "select ISNULL( SUM(cantk_3a),0) from custom_vianny.dbo.Qap3000 where pedido_3a ='" + Trim(DataGridView1.Rows(e.RowIndex).Cells(1).Value.ToString()) + "' and talm_3a ='" + alm + "' and Empr_3a ='" + Label4.Text + "' and ccom_3a ='1' and flag_3a ='1'"
            ...
            MsgBox(va.ToString())
            Rsr233.Close()
            vatot = Convert.ToInt32(DataGridView1.Rows(e.RowIndex).Cells(4).Value)
            If vatot > va Then
                MsgBox("LA CANTIDAD INGRESADA ES MAYOR A LOS INGRESADO EN EL PROCESO ANTERIOR --> EN EL PROCESO ANTERIO INGRESO  " + Convert.ToString(va) + " PRENDAS PARA REGULARIZAR LA OP ")
    ...
    Private Sub Button9_Click(sender As Object, e As EventArgs) Handles Button9.Click
        ...
        log.Label2.Text = "NSA-PRODUCCION"
