...
Public Class control_produccion_v2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "control_produccion_v2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.control_produccion_v2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fase() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcontrol_produccion_v2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As control_produccion_v2 = New control_produccion_v2()
        rpt.Site = Me.Site
        Return rpt
    End Function
