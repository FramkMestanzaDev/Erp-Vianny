...
Public Class RptListadoPMOD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.RptListadoPMOD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptListadoPMOD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptListadoPMOD = New RptListadoPMOD()
        rpt.Site = Me.Site
        Return rpt
    End Function
