...
Public Class Rpt_Partidaa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_Partidaa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Partidaa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Partidaa = New Rpt_Partidaa()
        rpt.Site = Me.Site
        Return rpt
    End Function
