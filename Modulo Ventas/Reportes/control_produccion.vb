...
Public Class control_produccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.control_produccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcontrol_produccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As control_produccion = New control_produccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
