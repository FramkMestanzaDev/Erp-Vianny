...
Public Class Consolidado_cons
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Consolidado_cons.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidado_cons
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Consolidado_cons = New Consolidado_cons()
        rpt.Site = Me.Site
        Return rpt
    End Function
