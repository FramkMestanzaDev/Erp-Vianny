...
Public Class Rpt_status_talla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_status_talla.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Aplicaciones_op() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_status_talla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_status_talla = New Rpt_status_talla()
        rpt.Site = Me.Site
        Return rpt
    End Function
