...
Public Class ReporteTelaOp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.ReporteTelaOp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteTelaOp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteTelaOp = New ReporteTelaOp()
        rpt.Site = Me.Site
        Return rpt
    End Function
