...
Public Class RptListadoPOOP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.RptListadoPOOP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptListadoPOOP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptListadoPOOP = New RptListadoPOOP()
        rpt.Site = Me.Site
        Return rpt
    End Function
