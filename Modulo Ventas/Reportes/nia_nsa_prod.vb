...
Public Class nia_nsa_prod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.nia_nsa_prod.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_condi() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachednia_nsa_prod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As nia_nsa_prod = New nia_nsa_prod()
        rpt.Site = Me.Site
        Return rpt
    End Function
