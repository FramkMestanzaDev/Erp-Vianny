...
Public Class Rpt_calidad_re
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_calidad_re.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_calidad_re
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_calidad_re = New Rpt_calidad_re()
        rpt.Site = Me.Site
        Return rpt
    End Function
