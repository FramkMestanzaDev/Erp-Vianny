...
Public Class Rpt_vend_rubro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_vend_rubro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_vend_rubro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_vend_rubro = New Rpt_vend_rubro()
        rpt.Site = Me.Site
        Return rpt
    End Function
