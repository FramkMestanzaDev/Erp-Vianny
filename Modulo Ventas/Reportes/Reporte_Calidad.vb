...
Public Class Reporte_Calidad
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Reporte_Calidad.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Calidad
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Calidad = New Reporte_Calidad()
        rpt.Site = Me.Site
        Return rpt
    End Function
