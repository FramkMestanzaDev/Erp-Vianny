...
Public Class Pack_almacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Pack_almacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPack_almacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pack_almacen = New Pack_almacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
