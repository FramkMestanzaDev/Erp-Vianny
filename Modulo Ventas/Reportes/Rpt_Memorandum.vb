...
Public Class Rpt_Memorandum
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_Memorandum.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Memorandum
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Memorandum = New Rpt_Memorandum()
        rpt.Site = Me.Site
        Return rpt
    End Function
