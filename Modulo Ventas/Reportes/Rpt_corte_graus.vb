...
Public Class Rpt_corte_graus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_corte_graus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_corte_graus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_corte_graus = New Rpt_corte_graus()
        rpt.Site = Me.Site
        Return rpt
    End Function
