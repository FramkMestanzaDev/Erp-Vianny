...
Public Class Reporte_corte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Reporte_corte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_corte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_corte = New Reporte_corte()
        rpt.Site = Me.Site
        Return rpt
    End Function
