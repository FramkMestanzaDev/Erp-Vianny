...
Public Class Rpt_comision2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_comision2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_comision2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_comision2 = New Rpt_comision2()
        rpt.Site = Me.Site
        Return rpt
    End Function
