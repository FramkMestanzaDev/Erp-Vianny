...
Public Class rpt_vrntas_cliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.rpt_vrntas_cliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_vrntas_cliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_vrntas_cliente = New rpt_vrntas_cliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
