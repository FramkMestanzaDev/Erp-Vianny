...
Public Class Status_op_talla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Status_op_talla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatus_op_talla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Status_op_talla = New Status_op_talla()
        rpt.Site = Me.Site
        Return rpt
    End Function
