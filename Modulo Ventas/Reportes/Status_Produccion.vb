...
Public Class Status_Produccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Status_Produccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatus_Produccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Status_Produccion = New Status_Produccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
