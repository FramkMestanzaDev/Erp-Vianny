...
Public Class Rpt_hoja_reclamo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_hoja_reclamo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_hoja_reclamo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_hoja_reclamo = New Rpt_hoja_reclamo()
        rpt.Site = Me.Site
        Return rpt
    End Function
