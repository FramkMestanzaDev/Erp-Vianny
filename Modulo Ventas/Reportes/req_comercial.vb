...
Public Class req_comercial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.req_comercial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreq_comercial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As req_comercial = New req_comercial()
        rpt.Site = Me.Site
        Return rpt
    End Function
