...
Public Class Rpt_Calidad1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_Calidad1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Calidad1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Calidad1 = New Rpt_Calidad1()
        rpt.Site = Me.Site
        Return rpt
    End Function
