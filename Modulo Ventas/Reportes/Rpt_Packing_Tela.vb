...
Public Class Rpt_Packing_Tela
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_Packing_Tela.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Packing_Tela
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Packing_Tela = New Rpt_Packing_Tela()
        rpt.Site = Me.Site
        Return rpt
    End Function
