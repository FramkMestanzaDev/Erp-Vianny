...
Public Class Producto_ter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Producto_ter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProducto_ter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Producto_ter = New Producto_ter()
        rpt.Site = Me.Site
        Return rpt
    End Function
