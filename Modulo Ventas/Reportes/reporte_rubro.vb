...
Public Class reporte_rubro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.reporte_rubro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreporte_rubro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporte_rubro = New reporte_rubro()
        rpt.Site = Me.Site
        Return rpt
    End Function
