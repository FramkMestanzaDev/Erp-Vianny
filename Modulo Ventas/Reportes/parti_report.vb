...
Public Class parti_report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.parti_report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedparti_report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As parti_report = New parti_report()
        rpt.Site = Me.Site
        Return rpt
    End Function
