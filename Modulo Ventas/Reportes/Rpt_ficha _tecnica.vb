...
Public Class Rpt_ficha__tecnica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Ventas.Rpt_ficha _tecnica.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CODIGO_TELA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRpt_ficha__tecnica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_ficha__tecnica = New Rpt_ficha__tecnica()
        rpt.Site = Me.Site
        Return rpt
    End Function
